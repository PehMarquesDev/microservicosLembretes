// Serviço de consulta apenas receberá requisições. Não fará.
// Por isso não precisa do pacote axios

const express = require("express");

// adição do axios para requisitar eventos perdidos ao barramento
